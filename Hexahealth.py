...
driver.find_element(By.XPATH,"//input[@id='contactnum2']").send_keys("1000000236")
...
driver.find_element(By.XPATH,"//input[@id='contactnumhome']").send_keys("1000000095")
...
driver.find_element(By.XPATH,"//input[@id='contactnum1']").send_keys("1000000548")
