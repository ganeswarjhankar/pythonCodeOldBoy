...
driver.find_element(By.XPATH,"//input[@id='contactnum2']").send_keys("1000000233")
...
driver.find_element(By.XPATH,"//input[@id='contactnumhome']").send_keys("1000000765")
...
driver.find_element(By.XPATH,"//input[@id='contactnum1']").send_keys("1000000648")
